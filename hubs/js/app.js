...
'🌍 성경 전체 흐름 | 🏺 출애굽 → 🏜️ 광야 → 🌊 요단강 → 🏞️ 가나안 → 👑 하나님 나라 → 🌍 새 창조',
...
'🔗 연결 흐름 | 🌊 요단강 → 🪨 길갈 → 🏰 여리고 → 🧵 라합 구원 → ⚔️ 정복 확대',
...
'🌍 성경 전체 흐름 | 🏰 여리고 심판 → 🧵 라합 구원 → 👑 다윗 계보 → ✝️ 예수 그리스도 → ⛪ 열방 구원',
...
'🔗 연결 흐름 | 🏰 여리고 → 🏰 아이성 → 🤝 기브온 → ⚔️ 남부 정복 → ⚔️ 북부 정복 → 🗺️ 기업 분배',
...
'🌍 성경 전체 흐름 | 🐪 아브라함 언약 → 🏺 출애굽 → 🏜️ 광야 → 🏞️ 가나안 정복 → 👑 왕국 → ✝️ 예수 그리스도',
...
'🔗 연결 흐름 | ⚔️ 정복 → ⛺ 실로 → 🗺️ 제비뽑기 → 🗺️ 지파별 기업 → 🏰 도피성 → 📜 세겜 언약',
...
'🌍 성경 전체 흐름 | 🏞️ 약속의 땅 → 🗺️ 지파별 기업 → 🏰 성전 중심 공동체 → 🗺️ 그리스도 안의 유업',
...
'🔗 연결 흐름 | 🗺️ 기업 분배 → 📜 세겜 회고 → 📌 여호와 섬김의 선택 → 🛡️ 여호수아 죽음 → ⚖️ 사사시대',
...
'🌍 성경 전체 흐름 | 🏺 출애굽 은혜 → ⚔️ 정복 은혜 → 📜 세겜 언약 → ⚖️ 사사시대 위기 → 👑 왕국 → 📜 새 언약',
...
render(current);
setTimeout(cenM04ScrollToHash,120);



function cenM04ScrollToHash(){
...
window.addEventListener('load',()=>setTimeout(cenM04ScrollToHash,120));
